...
public class SnakeAndLadderService {
    ...
    private void movePlayer(Player player, int positions) {
        ...
        System.out.println(player.getName() + " rolled a number " + positions + " and moved from  positions " + oldPosition +" to " + newPosition);
        System.out.println();
    }
    ...
    public void startGame() {
        while (!isGameCompleted()) {
            ...
            if (hasPlayerWon(currentPlayer)) {
                System.out.println("Hurray!!!!!"+" " +currentPlayer.getName() + " wins the game");
